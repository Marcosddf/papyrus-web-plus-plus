...
public class UMLExplorerItemContextMenuEntryProvider implements ITreeItemContextMenuEntryProvider {
    ...
    public UMLExplorerItemContextMenuEntryProvider(IObjectSearchService objectSearchService, ILibrarySearchService librarySearchService, ISemanticDataSearchService semanticDataSearchService, IPapyrusReadOnlyChecker readOnlyChecker, UMLDefaultTreeExplorerInstaller umlDefaultTreeInstaller) {
