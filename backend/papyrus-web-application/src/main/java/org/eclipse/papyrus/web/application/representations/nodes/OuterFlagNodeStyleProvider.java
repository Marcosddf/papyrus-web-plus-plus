...
/**
 * This class provides style information for the custom outer node flag.<br>
 ...
 */
@Service
public class OuterFlagNodeStyleProvider implements INodeStyleProvider {

    public static final String NODE_OUTER_FLAG = "customnode:outerFlag";

    @Override
    public Optional<String> getNodeType(NodeStyleDescription nodeStyle) {
        if (nodeStyle instanceof OuterFlagNodeStyleDescription) {
            return Optional.of(NODE_OUTER_FLAG);
        }
    ...
    public Optional<INodeStyle> createNodeStyle(NodeStyleDescription nodeStyle, Optional<String> optionalEditingContextId, ILayoutStrategy childrenLayoutStrategy) {
        ...
        if (nodeType.isPresent() && nodeStyle instanceof OuterFlagNodeStyleDescription flagStyle) {
            return Optional.of(OuterFlagNodeStyle.newOuterFlagNodeStyle()
                    .background(Optional.ofNullable(((OuterFlagNodeStyleDescription) nodeStyle).getBackground())
