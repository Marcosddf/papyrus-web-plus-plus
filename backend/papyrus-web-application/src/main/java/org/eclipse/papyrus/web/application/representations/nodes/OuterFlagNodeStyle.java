...
/**
 * The outer flag node style. Code duplicated from <a href="https://github.com/eclipse-sirius/sirius-web">Sirius Web</a>
 * (sirius-web-sample-application\src\main\java\org\eclipse\sirius\web\sample\nodes\EllipseNodeStyle.java).
 *
 * @author <a href="mailto:gwendal.daniel@obeosoft.com">Gwendal Daniel</a>
 */
@Immutable
public final class OuterFlagNodeStyle implements INodeStyle {
    ...
    private OuterFlagNodeStyle() {
        // Prevent instantiation
    }

    public static Builder newOuterFlagNodeStyle() {
        return new Builder();
    }
    ...
    /**
     * The builder used to create the outer flag node style.
     *
     * @author <a href="mailto:gwendal.daniel@obeosoft.com">Gwendal Daniel</a>
     */
    ...
    public static final class Builder {
        ...
        public OuterFlagNodeStyle build() {
            OuterFlagNodeStyle nodeStyleDescription = new OuterFlagNodeStyle();
