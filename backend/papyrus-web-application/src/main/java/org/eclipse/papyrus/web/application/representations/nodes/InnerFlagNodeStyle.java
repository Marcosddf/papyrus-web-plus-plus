...
/**
 * The inner flag node style. Code duplicated from <a href="https://github.com/eclipse-sirius/sirius-web">Sirius Web</a>
...
public final class InnerFlagNodeStyle implements INodeStyle {
    ...
    private InnerFlagNodeStyle() {
        // Prevent instantiation
    }

    public static Builder newInnerFlagNodeStyle() {
        return new Builder();
    }
    ...
    /**
     * The builder used to create the inner flag node style.
     *
     * @author <a href="mailto:gwendal.daniel@obeosoft.com">Gwendal Daniel</a>
     */
