...
/**
 * The package node style. Code duplicated from <a href="https://github.com/eclipse-sirius/sirius-web">Sirius Web</a>
 * (sirius-web-sample-application\src\main\java\org\eclipse\sirius\web\sample\nodes\EllipseNodeStyle.java).
 *
 * @author <a href="mailto:gwendal.daniel@obeosoft.com">Gwendal Daniel</a>
 */
@Immutable
public final class PackageNodeStyle implements INodeStyle {
    ...
    private PackageNodeStyle() {
        // Prevent instantiation
    }

    public static Builder newPackageNodeStyle() {
        return new Builder();
    }
    ...
    public static final class Builder {
        ...
        public PackageNodeStyle build() {
            PackageNodeStyle nodeStyleDescription = new PackageNodeStyle();
