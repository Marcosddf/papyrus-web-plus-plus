...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Rectangle With External Label Node Style
 * Description</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.RectangleWithExternalLabelNodeStyleDescriptionImpl#getBorderColor
 * <em>Border Color</em>}</li>
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.RectangleWithExternalLabelNodeStyleDescriptionImpl#getBorderRadius
 * <em>Border Radius</em>}</li>
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.RectangleWithExternalLabelNodeStyleDescriptionImpl#getBorderSize
 ...
 * @generated
 */
public class RectangleWithExternalLabelNodeStyleDescriptionImpl extends MinimalEObjectImpl.Container implements RectangleWithExternalLabelNodeStyleDescription {
    /**
     ...
     * @generated
     */
    protected RectangleWithExternalLabelNodeStyleDescriptionImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return PapyrusCustomNodesPackage.Literals.RECTANGLE_WITH_EXTERNAL_LABEL_NODE_STYLE_DESCRIPTION;
    }
        ...
        if (this.borderColor != null && this.borderColor.eIsProxy()) {
            ...
            if (this.borderColor != oldBorderColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, PapyrusCustomNodesPackage.RECTANGLE_WITH_EXTERNAL_LABEL_NODE_STYLE_DESCRIPTION__BORDER_COLOR, oldBorderColor,
                            this.borderColor));
            }
        }
    ...
    public void setBorderColor(UserColor newBorderColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.RECTANGLE_WITH_EXTERNAL_LABEL_NODE_STYLE_DESCRIPTION__BORDER_COLOR, oldBorderColor, this.borderColor));
    }
    ...
    public void setBorderRadius(int newBorderRadius) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(
                    new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.RECTANGLE_WITH_EXTERNAL_LABEL_NODE_STYLE_DESCRIPTION__BORDER_RADIUS, oldBorderRadius, this.borderRadius));
    }
    ...
    public void setBorderSize(int newBorderSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.RECTANGLE_WITH_EXTERNAL_LABEL_NODE_STYLE_DESCRIPTION__BORDER_SIZE, oldBorderSize, this.borderSize));
    }
    ...
    public void setBorderLineStyle(LineStyle newBorderLineStyle) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.RECTANGLE_WITH_EXTERNAL_LABEL_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE, oldBorderLineStyle,
    ...
    public UserColor getBackground() {
        if (this.background != null && this.background.eIsProxy()) {
            ...
            if (this.background != oldBackground) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, PapyrusCustomNodesPackage.RECTANGLE_WITH_EXTERNAL_LABEL_NODE_STYLE_DESCRIPTION__BACKGROUND, oldBackground,
                            this.background));
            }
        }
    ...
    public void setBackground(UserColor newBackground) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.RECTANGLE_WITH_EXTERNAL_LABEL_NODE_STYLE_DESCRIPTION__BACKGROUND, oldBackground, this.background));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case PapyrusCustomNodesPackage.RECTANGLE_WITH_EXTERNAL_LABEL_NODE_STYLE_DESCRIPTION__BORDER_RADIUS:
                return this.getBorderRadius();
            case PapyrusCustomNodesPackage.RECTANGLE_WITH_EXTERNAL_LABEL_NODE_STYLE_DESCRIPTION__BORDER_SIZE:
...
} // RectangleWithExternalLabelNodeStyleDescriptionImpl
