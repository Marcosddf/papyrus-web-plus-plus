 ...
 * {@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.OuterFlagNodeStyleDescription} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class OuterFlagNodeStyleDescriptionItemProvider extends ItemProviderAdapter
     ...
     * @generated
     */
    public OuterFlagNodeStyleDescriptionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addBackgroundPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_OuterFlagNodeStyleDescription_background_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_OuterFlagNodeStyleDescription_background_feature", "_UI_OuterFlagNodeStyleDescription_type"),
                PapyrusCustomNodesPackage.Literals.OUTER_FLAG_NODE_STYLE_DESCRIPTION__BACKGROUND,
                true,
                false,
                true,
                null,
    ...
    /**
     * This returns OuterFlagNodeStyleDescription.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/OuterFlagNodeStyleDescription"));
    }
    ...
    public String getText(Object object) {
        OuterFlagNodeStyleDescription outerFlagNodeStyleDescription = (OuterFlagNodeStyleDescription) object;
        return this.getString("_UI_OuterFlagNodeStyleDescription_type") + " " + outerFlagNodeStyleDescription.getBorderRadius();
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(OuterFlagNodeStyleDescription.class)) {
