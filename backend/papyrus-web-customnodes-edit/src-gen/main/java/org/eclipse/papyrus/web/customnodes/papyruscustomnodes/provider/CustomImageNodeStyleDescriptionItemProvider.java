 ...
 * {@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.CustomImageNodeStyleDescription} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class CustomImageNodeStyleDescriptionItemProvider
     ...
     * @generated
     */
    public CustomImageNodeStyleDescriptionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addBackgroundPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_CustomImageNodeStyleDescription_background_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_CustomImageNodeStyleDescription_background_feature", "_UI_CustomImageNodeStyleDescription_type"),
                PapyrusCustomNodesPackage.Literals.CUSTOM_IMAGE_NODE_STYLE_DESCRIPTION__BACKGROUND,
                true,
                false,
                true,
                null,
    ...
    protected void addShapePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_CustomImageNodeStyleDescription_shape_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_CustomImageNodeStyleDescription_shape_feature", "_UI_CustomImageNodeStyleDescription_type"),
                PapyrusCustomNodesPackage.Literals.CUSTOM_IMAGE_NODE_STYLE_DESCRIPTION__SHAPE,
                true,
                false,
                false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    /**
     * This returns CustomImageNodeStyleDescription.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/CustomImageNodeStyleDescription"));
    }
    ...
    public String getText(Object object) {
        CustomImageNodeStyleDescription customImageNodeStyleDescription = (CustomImageNodeStyleDescription) object;
        return this.getString("_UI_CustomImageNodeStyleDescription_type") + " " + customImageNodeStyleDescription.getBorderRadius();
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(CustomImageNodeStyleDescription.class)) {
