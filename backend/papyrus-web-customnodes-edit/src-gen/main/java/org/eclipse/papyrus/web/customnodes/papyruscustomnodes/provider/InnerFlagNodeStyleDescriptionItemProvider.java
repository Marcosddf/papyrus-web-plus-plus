 ...
 * {@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.InnerFlagNodeStyleDescription} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class InnerFlagNodeStyleDescriptionItemProvider extends ItemProviderAdapter
     ...
     * @generated
     */
    public InnerFlagNodeStyleDescriptionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addBackgroundPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_InnerFlagNodeStyleDescription_background_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_InnerFlagNodeStyleDescription_background_feature", "_UI_InnerFlagNodeStyleDescription_type"),
                PapyrusCustomNodesPackage.Literals.INNER_FLAG_NODE_STYLE_DESCRIPTION__BACKGROUND,
                true,
                false,
                true,
                null,
    ...
    /**
     * This returns InnerFlagNodeStyleDescription.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/InnerFlagNodeStyleDescription"));
    }
    ...
    public String getText(Object object) {
        InnerFlagNodeStyleDescription innerFlagNodeStyleDescription = (InnerFlagNodeStyleDescription) object;
        return this.getString("_UI_InnerFlagNodeStyleDescription_type") + " " + innerFlagNodeStyleDescription.getBorderRadius();
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(InnerFlagNodeStyleDescription.class)) {
