 ...
 * {@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.CuboidNodeStyleDescription} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class CuboidNodeStyleDescriptionItemProvider extends ItemProviderAdapter
     ...
     * @generated
     */
    public CuboidNodeStyleDescriptionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addBackgroundPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                this.getResourceLocator(),
                this.getString("_UI_CuboidNodeStyleDescription_background_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_CuboidNodeStyleDescription_background_feature", "_UI_CuboidNodeStyleDescription_type"),
                PapyrusCustomNodesPackage.Literals.CUBOID_NODE_STYLE_DESCRIPTION__BACKGROUND,
                true,
                false,
                true,
                null,
    ...
    /**
     * This returns CuboidNodeStyleDescription.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/CuboidNodeStyleDescription"));
    }
    ...
    public String getText(Object object) {
        CuboidNodeStyleDescription cuboidNodeStyleDescription = (CuboidNodeStyleDescription) object;
        return this.getString("_UI_CuboidNodeStyleDescription_type") + " " + cuboidNodeStyleDescription.getBorderRadius();
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(CuboidNodeStyleDescription.class)) {
